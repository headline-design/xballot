const Preview = (props) => {
  ...
  return props.flex ? (
    <div id="flex" style={{ display: 'flex' }}>
      <div className="flex">
        <div
          className="MuiGrid-root MuiGrid-item MuiGrid-grid-xs-12 MuiGrid-grid-sm-4 MuiGrid-grid-md-3 flex-grow"
          style={{ maxWidth: '75%' }}
        >
          <div className="jss69">
            <div className="jss70">
        ...
        <div className="flex2">
          <div className="flex3">
            ...
            <p>
              <b>Note: </b>If the image of your ARC NFT isn't appearing yet, give it a moment, it
              might be shy.
            </p>
          </div>
          <button
