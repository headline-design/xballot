...
const IconInput = ({ icon, type, name, title, value, onChange, placeholder, maxLength }) => {
  ...
  return (
    <>
      <div className="group w-full rounded-3xl">
        ...
        <div className="relative z-10 flex w-full rounded-3xl border border-skin-border bg-skin-bg px-6 pr-4 text-left leading-[42px] outline-none transition-colors focus-within:border-skin-text">
